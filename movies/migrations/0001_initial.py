    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(blank=True, default=0, null=True, verbose_name='Возраст')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='Укажите сумму в долларах', verbose_name='Сборы_в_США')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='Укажите сумму в долларах', verbose_name='Сборы_в_США')),
                ('url', models.SlugField(max_length=160, unique=True)),
